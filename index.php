    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="https://via.placeholder.com/600x400/d4d4d4/666666?text=Pharmacy+Interior" alt="Pharmacy" class="img-fluid rounded">
                </div>
                <div class="col-md-6">
                    ...
                    <a href="order-medicines.php" class="btn btn-dark btn-lg">Shop Now</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="features-section py-5 bg-light">
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-4 mb-4">
                    <div class="feature-icon mb-3">
                        <i class="bi bi-patch-check" style="font-size: 4rem;"></i>
                    </div>
                    <h4>Safe & Accurate</h4>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="feature-icon mb-3">
                        <i class="bi bi-shield-plus" style="font-size: 4rem;"></i>
                    </div>
    ...
    <section class="featured-products py-5">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <a href="order-medicines.php" class="text-decoration-none">View all products</a>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card product-card h-100">
                        ...
                        <span class="badge-label"><?php echo $product['badge']; ?></span>
                        <?php endif; ?>
    ...
    <section class="why-choose-us py-5 bg-light">
        <div class="container">
            ...
            <div class="row text-center mb-4">
                <div class="col-md-4 mb-4">
                    <div class="feature-icon mb-3">
                        <i class="bi bi-person-check" style="font-size: 4rem;"></i>
                    </div>
            ...
            <div class="text-center">
                <a href="order-medicines.php" class="btn btn-dark btn-lg">Explore Products</a>
            </div>
        </div>
    </section>
